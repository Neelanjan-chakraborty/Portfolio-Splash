...
var designTitle = document.getElementById("code");
var codeTitle = document.getElementById("design");

// Add glow effect on hover for the design and code titles
designTitle.addEventListener("mouseover", function() {
  designTitle.classList.add("glow");
});

designTitle.addEventListener("mouseout", function() {
  designTitle.classList.remove("glow");
});

codeTitle.addEventListener("mouseover", function() {
  codeTitle.classList.add("glow");
});

codeTitle.addEventListener("mouseout", function() {
  codeTitle.classList.remove("glow");
});
